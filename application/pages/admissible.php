...
if (isset($_SESSION['demande']) && isset($_POST['user'])) {
	...
	elseif (!$demandeManager->autorisation($_SESSION['demande'])) {
		...
		// envoi d'un email de validation contenant <a href="http://.../?code=$_SESSION['demande']->code()">Valider votre demande</a> <a href="http://.../?code=$_SESSION['demande']->code()">Annuler votre demande</a>
